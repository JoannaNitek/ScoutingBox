...
class PlayerView(LoginRequiredMixin, View):
    ...
    def get(self, request, player_id):
        ...
        return render(request, 'one-player.html', {"q": q, 'observ': observ, 'player': player, 'com': com, 'stats': context, 'players': players})
...
#         # observ = ObservationForm.objects.filter(player__observationform=player)
#
#         return render(request, 'comparison.html', {'player': player, 'form': form})
...
class ComparisonView(LoginRequiredMixin, View):
     ...
     def get(self, request, play_1, play_2):
         ...
         return render(request, 'comparison.html', {'p_1': p_1, 'p_2': p_2, 'observ1': observ1, 'observ2': observ2, 'q': q, 'context1': context1, 'context2': context2, 'count2': count2, 'count1': count1})
